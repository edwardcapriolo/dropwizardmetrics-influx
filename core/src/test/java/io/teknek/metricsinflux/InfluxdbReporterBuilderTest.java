...
import io.teknek.metricsinflux.InfluxdbReporter.Builder;
...
public class InfluxdbReporterBuilderTest {
	...
	public void builder_api_with_tags_checksNullKey() {
		...
		assertThrows(NullPointerException.class, () -> InfluxdbReporter
				.forRegistry(registry)
				.tag(null, tagValue));
	}
	...
	public void builder_api_with_tags_checksEmptyKey() {
		...
		assertThrows(IllegalArgumentException.class, () -> InfluxdbReporter
				.forRegistry(registry)
				.tag("", tagValue));
	}
