package io.teknek.metricsinflux.serialization.line;

import io.teknek.metricsinflux.measurements.Measure;
...
public class InlinerTest {
	...
	public void a_timestamp_is_generated_when_none_is_provided() {
		...
		assertTrue(matcher.matches(), "generated output ends with a number");
